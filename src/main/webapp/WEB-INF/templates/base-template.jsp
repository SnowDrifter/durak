...
<head>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/jquery.min.js"><jsp:text/></script>
    <script src="${pageContext.request.contextPath}/resources/js/jquery-dateformat.min.js"><jsp:text/></script>
